...
/* package CorePrettyPrinter-0.1 */
#define VERSION_CorePrettyPrinter "0.1"
#define MIN_VERSION_CorePrettyPrinter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package VHDLGen-0.1 */
#define VERSION_VHDLGen "0.1"
#define MIN_VERSION_VHDLGen(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
/* package ghc-paths-0.1.0.8 */
#define VERSION_ghc_paths "0.1.0.8"
...
/* package vhdl-0.1.2.1 */
#define VERSION_vhdl "0.1.2.1"
#define MIN_VERSION_vhdl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
